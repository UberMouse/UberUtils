...
public class UberSkills
{
	...
	public static int getExpToLevel(final int index, final int endLvl) {
		...
		if (lvl == 120 || endLvl > 120)
			return 0;
		return Skills.XP_TABLE[endLvl] - Skills.getExperience(index);
	}
	...
	public static int getTotalLevel() {
		int total = 0;
		for (int i = 0; i < SKILL_NAMES.length - 1; i++) {
	...
	public static boolean doHover(final int component) {
		...
		Time.sleep(Utils.random(10, 100));
		return Widgets.get(INTERFACE_TAB_STATS, component).hover();
	}
}
