 ...
 * Date: 4/2/11
 * Time: 12:24 AM
 * Package: nz.uberutils.paintType.components;
 */
public class PDialogue extends PComponent
{
    ...
    public class Button extends PFancyButton
    {
        ...
        public void paint(Graphics2D g) {
            ...
            g.setFont(cFont);
            g.drawString(type.getText(),
                    (x + (width / 2) - (cMetrics.stringWidth(type.getText()) / 2)),
    ...
    public void repaint(Graphics2D g) {
        ...
        x = x == -1 ? (Game.getDimensions().width / 2) - width / 2 : x;
        y = y == -1 ? (Game.getDimensions().height / 2) - height : y;
        ...
        g.drawString(title,
                (x + (width / 2) - (tMetrics.stringWidth(title) / 2)) + 1,
                y + ((tMetrics.getMaxAscent() + 8) / 2) + (int) (tMetrics.getMaxAscent() / (tFont.getSize() / 4.5)));
        ...
        if (buttons == null) {
            if (type == Type.INFORMATION || type == Type.ERROR || type == Type.WARNING) {
                buttons = new Button[]{new Button(x + 6,
                ...
                buttons = new Button[]{new Button(x + 5,
                        (y + (getContentHeight() - 24)),
                        ((width - 12) / 3) - 3,
                        18,
                        ButtonType.YES),
